...
const Login = () => {
  ...
  const [showPassword] = useState(false);   const handleChange = (e) => {
...
console.log(data)
  ...
  return (
    ...
    <div className="bg-gray-50 p-3 border rounded-xl shadow-xl max-w-3xl w-full sm:w-11/12 md:w-9/12 lg:w-8/12">
      ...
      <div className="flex flex-col md:flex-row">
        <div className="w-full  px-5 mt-5">
          <form className="flex flex-col gap-1">
            ...
            <p>By continuing, you agree to our Conditions of Use and <span className="text-blue-600 cursor-pointer">Privacy Notice.</span> </p>
          </form>
